...
C_SOURCES = $(wildcard kernel/*.c drivers/*.c cpu/*.c games/*.c)
HEADERS = $(wildcard kernel/*.h  drivers/*.h cpu/*.h games/*.h)
...
%.o: %.c $(HEADERS)
	gcc -fno-pie -g -m32 -ffreestanding -c $< -o $@ -fno-stack-protector
