...
// typedef char16_t wchar_T; // UTF-16, but should use UCS-2 code points
// 0x0000-0xFFFF typedef void VOID;
...
// typedef EFI_STATUS(EFIAPI *EFI_INPUT_READ_KEY)(IN
// EFI_SIMPLE_TEXT_INPUT_PROTOCOL *This, OUT EFI_INPUT_KEY *Key);
...
// typedef EFI_STATUS(EFIAPI *EFI_TEXT_STRING)(IN
// EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This, IN CHAR16 *String);

// typedef EFI_STATUS(EFIAPI *EFI_TEXT_SET_ATTRIBUTE)(IN
// EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *This, IN UINTN Attribute);

// typedef EFI_STATUS(EFIAPI *EFI_TEXT_CLEAR_SCREEN)(IN
...
// typedef VOID(EFIAPI *EFI_RESET_SYSTEM)(IN EFI_RESET_TYPE ResetType, IN
